...
import ShelfItemContainer from '../ShelfItemContainer'
import './index.css'
import FooterContainer from '../FooterContainer'
import BooksItemContainer from '../BooksItemContainer'
...
class BooksShelvesContainer extends Component {
  state = {
    searchInput: '',
  ...
  renderBooks = booksList => (
    <ul className="book-items-details-container">
      {booksList.map(eachBook => (
        <BooksItemContainer key={eachBook.id} bookDetails={eachBook} />
      ))}
    </ul>
  )
...
export default BooksShelvesContainer
